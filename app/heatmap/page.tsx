  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 ml-60">
        {/* Page Header */}
        <PageHeader title="Interactive Heat Map" subtitle="Visualize incident hotspots across Brgy. Banay-Banay 2nd" />

        {/* Content: Control Panel + Map */}
        <div className="flex h-[calc(100vh-3.5rem)]">
          {/* Left Control Panel - 25% */}
          <aside className="w-[25%] border-r border-border bg-[#f2f4f6] overflow-hidden">
            <HeatmapControls
